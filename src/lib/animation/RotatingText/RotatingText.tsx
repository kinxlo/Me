...
export interface RotatingTextReference {
  next: () => void;
  previous: () => void;
...
export interface RotatingTextProperties
  extends Omit<
...
const RotatingText = forwardRef<RotatingTextReference, RotatingTextProperties>(
  (
    {
      texts,
