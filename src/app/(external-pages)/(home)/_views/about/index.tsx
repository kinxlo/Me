...
export const About = () => {
  return (
    <section id={`about-section`} className={`cc-3d-group`}>
      ...
      <Wrapper className={`cc-border bg-primary mt-10`}>
        <PlainCard
          className={`text-primary cc-bg-dotted bg-background font-sea grid grid-cols-1 gap-2 p-2 text-justify text-2xl/9 md:grid-cols-2 lg:mx-0`}
        >
          ...
          <div id="map-section" className={`relative overflow-hidden border-none`}>
